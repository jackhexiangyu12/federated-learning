...
if __name__ == '__main__':
    ...
    for iteration in range(1):
        ...
        for idx in range(args.num_users):
            ...
            net_client.eval()
            acc_train, loss_train1 = test_img(net_client, dataset_train, args)
            acc_test, loss_test = test_img(net_client, dataset_test, args)
            acc_train_all+=acc_train
            acc_test_all+=acc_test
        acc_train_all=acc_train_all/args.num_users
        acc_test_all=acc_test_all/args.num_users
        print("Training accuracy: {:.2f}".format(acc_train_all))
        print("Testing accuracy: {:.2f}".format(acc_test_all))
